        ...
        <header className='height-75'>
         ...
         align-items-center justify-content-center text-light'>
          ...
          <p className='text-center w-75 mb-5'>Lorem ipsum dolor sit amet consectetur adipisicing elit. 
            Distinctio deleniti excepturi culpa neque nisi qui quos, 
            cupiditate repudiandae nam ipsum ratione itaque. 
            Assumenda id optio quia eligendi eveniet nesciunt aut!</p>
         </div>
        </header>
